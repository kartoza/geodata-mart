...
MIGRATION_MODULES = {"sites": "geodata_mart.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "geodata_mart.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
# ADMINS = [("""Kartoza""", "devops@kartoza.com")]
ADMINS = [("""Charlie""", "charles@kartoza.com")]
...
ACCOUNT_FORMS = {"signup": "geodata_mart.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "geodata_mart.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "geodata_mart.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
