# Generated by Django 3.2.13 on 2022-07-17 15:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config_qgis', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='maps.qgisinifile', verbose_name='QGIS Configuration File')),
                ('qgis_project_file', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='maps.qgisprojectfile', verbose_name='QGIS Project File')),
                ...
                ('vendor_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='vendors.vendor', verbose_name='Data Vendor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_default', models.BooleanField(default=True, help_text='Define whether this layer should be checked by default', verbose_name='Default')),
